...
byobu new-session -d -s ur3e_wiggle
...
sleep 5.
byobu send-keys -t 2 'xhost + && docker exec -it ur3e_container bash -it -c "roslaunch ur3e_tutorials wiggle.launch"' 'C-m'

byobu attach -t u3e_wiggle