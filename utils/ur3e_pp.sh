...
sleep 5.
byobu send-keys -t 2 'xhost + && docker exec -it ur3e_container bash -it -c "roslaunch ur3e_tutorials pick_and_place.launch use_gripper:=true"' 'C-m'

byobu attach -t ur3e_pp